...
class Unit extends AdminController
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Unit_model->addEvent(10, $this->idUser, $this->serialize_data($data));
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Unit_model->addEvent(11, $this->idUser, $keterangan);
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            if ($result) {
                $this->Unit_model->addEvent(12, $this->idUser, $this->serialize_data($row));
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('nama', 'nama unit', 'trim|required');
