        ...
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                ...
                <div class="col-md-4 text-right">
                    <?php
                if ($idDosen) {
                    echo anchor(site_url('DataDokumenLainDosenAdmin/create/' .  $idJenisDokumenLain . '/' . $idTahunPelaksanaan . '/' . $idDosen), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"');
                }
                ?>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div id="modalBody" class="modal-body">
                            <?php echo form_open_multipart('DataDokumenLainDosenAdmin/upload'); ?>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        "url": "DataDokumenLainDosenAdmin/json",
                        "data": function(data) {
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('DataDokumenLainDosenAdmin/getUrlDokumen'); ?>",
                    data: myFormData,
            ...
            function deleteFile(ID) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url('DataDokumenLainDosenAdmin/deleteDokumen'); ?>",
                        data: myFormData,
                        success: function(data) {
                            if (data == "") {
