    ...
    <div class="box">
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4">
                    <h2 style="margin-top:0px">Dokumen Dosen</h2>
                </div>
                <div class="col-md-4 text-center">
                    <?= showFlashMessage() ?>
                </div>
                <div class="col-md-4 text-right">
                    <?php echo anchor(site_url('InputDokumenLainDosen/create/' .  $idJenisDokumenLain), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); ?>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div id="modalBody" class="modal-body">
                            <?php echo form_open_multipart('InputDokumenLainDosen/upload'); ?>
                            <input type="hidden" name="idInputDokumenLainDosen">
                            <input type="hidden" name="idJenisDokumenLain" value="<?= $idJenisDokumenLain; ?>">
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        "url": "InputDokumenLainDosen/json",
                        "data": function(data) {
            ...
            function unggahBerkas(ID) {
                ...
                $("input[name='idInputDokumenLainDosen']").val(ID);
            }
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('InputDokumenLainDosen/getUrlDokumen'); ?>",
                    data: myFormData,
            ...
            function deleteFile(ID) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url('InputDokumenLainDosen/deleteDokumen'); ?>",
                        data: myFormData,
                        success: function(data) {
                            if (data == "") {
            ...
            $('select[name="idJenisDokumenLain"]').on('change', function() {
                ...
                window.open(window.location.pathname + '?idJenisDokumenLain=' + idJenisDokumenLain, '_self');
            });
            </script>