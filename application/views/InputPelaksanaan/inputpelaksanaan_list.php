<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Input Pelaksanaan</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="box">
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-8">
                    <h2 style="margin-top:0px">Pelaksanaan <?php echo $prodi;?> </h2>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div id="modalBody" class="modal-body">
                            <?php echo form_open_multipart('InputPelaksanaan/upload'); ?>
                            <input type="hidden" name="idDetailPelaksanaan">
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        "url": "InputPelaksanaan/json/" + <?php echo $idTahunPelaksanaan;?>,
                        "type": "POST"
                    },
                    columns: [{
                            "data": "ID",
            ...
            function unggahBerkas(ID) {
                ...
                $("input[name='idDetailPelaksanaan']").val(ID);
            }
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('InputPelaksanaan/getUrlDokumen'); ?>",
                    data: myFormData,
            ...
            function deleteFile(ID) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url('InputPelaksanaan/deleteDokumen'); ?>",
                        data: myFormData,
                        success: function(data) {
                            if (data == "") {
