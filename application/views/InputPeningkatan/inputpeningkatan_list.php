<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Peningkatan</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="box">
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4">
                    <h2 style="margin-top:0px">Peningkatan</h2>
                </div>
                <div class="col-md-4 text-center">
                    <?= showFlashMessage() ?>
                </div>
                <div class="col-md-4 text-right">
                    <?php echo anchor(site_url('InputPeningkatan/create'), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); ?>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div id="modalBody" class="modal-body">
                            <?php echo form_open_multipart('InputPeningkatan/upload'); ?>
                            <input type="hidden" name="idPeningkatan">
            ...
            function unggahBerkas(ID) {
                ...
                $("input[name='idPeningkatan']").val(ID);
            }
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('InputPeningkatan/getUrlDokumen'); ?>",
                    data: myFormData,
            ...
            function deleteFile(ID) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url('InputPeningkatan/deleteDokumen'); ?>",
                        data: myFormData,
                        success: function(data) {
                            if (data == "") {
