<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Data Peningkatan</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="box">
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-8">
                    <h2 style="margin-top:0px">Data Peningkatan</h2>
                </div>
            </div>
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('DataPeningkatan/getUrlDokumen'); ?>",
                    data: myFormData,
