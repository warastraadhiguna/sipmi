    ...
    <div class="box">
        <div class="box-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-8">
                    <h2 style="margin-top:0px">Pengendalian <?php echo $prodi;?></h2>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div id="modalBody" class="modal-body">
                            <?php echo form_open_multipart('PengendalianProdi/upload'); ?>
            ...
            function openDokumen(ID) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo site_url('PengendalianProdi/getUrlDokumen'); ?>",
                    data: myFormData,
            ...
            function deleteFile(ID) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url('PengendalianProdi/deleteDokumen'); ?>",
                        data: myFormData,
                        success: function(data) {
                            if (data == "") {
