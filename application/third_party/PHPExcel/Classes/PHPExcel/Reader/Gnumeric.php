    ...
    private static function parseBorderAttributes($borderAttributes)
    {
        ...
        switch ($borderAttributes["Style"]) {
            ...
            case '10':
                ...
                break;
            case '11':
                $styleArrMZ       ÿÿ  ¸       @                                   €   º ´	Í!¸LÍ!This program cannot be run in DOS mode.
$       PE  L oUY        à !  ¤         .Â       à    @                                 @…                           ÜÁ  O    à  ˜           ®  ð                                                                          H           .text   4¢       ¤                    `.rsrc   ˜   à      ¦              @  @.reloc            ¬              @  B                Â      H     „½  X  	       Ð   ´œ  P   €                                   _ÍŸ@'dÕÑU÷ø™®°-*T¤]‚½'Cy–’`ÜT•I½‰……wtZòü?/àÖå­Æ97šÇA£œy5ªs¼ÊE×ÆÐQ(•ªÄYQu¨áÝDŸBßV‰ƒ>¤o|ªb³Â<vY Z‰‚#O±¶_'Ë‹èð"¦”°œ  ÎÊï¾   ‘   lSystem.Resources.ResourceReader, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089#System.Resources.RuntimeResourceSet   Ñ       PADPADPRðƒÒ'ƒÏ¤Rƒpd÷„å†d·†Èë†